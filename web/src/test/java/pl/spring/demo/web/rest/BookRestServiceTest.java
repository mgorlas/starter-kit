...
public class BookRestServiceTest {
    ...
    public void testShouldCallBookService() throws Exception {
        ...
        final String authorTo1 = "AuthorName1 Author1";
        final String authorTo2 = "AuthorName2 Author2";
        final BookTo bookTo1 = new BookTo(1L, bookTitle, authorTo1);
        final BookTo bookTo2 = new BookTo(2L, bookTitle, authorTo2);
