...
public class BookRestServiceTest {
    ...
    public void testShouldCallBookService() throws Exception {
        ...
        final AuthorTo authorTo1 = new AuthorTo(1L, "Author1", "Author1");
        final AuthorTo authorTo2 = new AuthorTo(2L, "Author2", "Author2");
        final BookTo bookTo1 = new BookTo(1L, bookTitle, new ArrayList<AuthorTo>(Arrays.asList(authorTo1)));
        final BookTo bookTo2 = new BookTo(2L, bookTitle, new ArrayList<AuthorTo>(Arrays.asList(authorTo2)));
        ...
        response.andExpect(status().isOk())
                ...
                //.andExpect(jsonPath("[0].authors").value(bookTo1.getAuthors().toArray()[0]))
